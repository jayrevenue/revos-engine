-- Phase 1: Database Schema Transformation for TRS RevOS Platform
...
-- Update ai_agents to reference orgs and engagements
UPDATE public.ai_agents SET 
  org_id = (SELECT o.id FROM public.orgs o JOIN public.clients c ON c.company = o.name LIMIT 1),
  engagement_id = (SELECT e.id FROM public.engagements e LIMIT 1)
