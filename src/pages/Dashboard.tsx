...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 flex">
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'w-64' : 'w-16'} transition-all duration-200 bg-slate-50 dark:trs-gradient-dark border-r border-slate-200 dark:border-slate-700 flex flex-col`}>
        {/* Logo */}
        <div className="p-6 border-b border-slate-200 dark:border-slate-700">
          <div className="flex items-center">
            <div className="w-8 h-8 bg-slate-900 dark:bg-orange-600 rounded-lg flex items-center justify-center">
              <TrendingUp className="w-4 h-4 text-white" />
            </div>
            {sidebarOpen && (
              <div className="ml-3">
                <h1 className="text-lg font-medium text-slate-900 dark:text-white">Revenue Science</h1>
              </div>
            )}
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h2 className="ml-4 text-xl font-medium text-slate-900 dark:text-white">Dashboard Overview</h2>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className="px-3 py-1 text-sm text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white border border-slate-200 dark:border-slate-600 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                >
                  Sign Out
                </button>
              </div>
        ...
        {/* Dashboard Content */}
        <main className="flex-1 p-6 bg-gradient-to-b from-white to-slate-50 dark:from-slate-900 dark:to-slate-800">
          {/* Stats Grid */}
